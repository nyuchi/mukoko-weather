        ...
        <div className="mb-8 flex flex-wrap items-center gap-x-8 gap-y-4 border-b border-text-tertiary/10 pb-8">
          ...
          <div className="ml-auto flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-text-tertiary/20 bg-surface-card px-4 py-2 text-base font-medium text-text-secondary transition-colors hover:border-primary/40 hover:text-primary"
            >
